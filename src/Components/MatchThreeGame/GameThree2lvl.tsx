            ...
            <div className={classes.gamePage}>
                ...
                { states.showButtonsWhenWinning && <div className={classes.winAndLoseModal}>  
                    <div className={classes.infoOverlay}>
                        <p className={classes.info}>Я же говорила: когда работа идёт дружно, время проходит незаметно.</p>
                    </div>
                ...
                <div className={classes.gameField}>
                        ...
                        { states.showModalInfo && <div>
                            <div className={states.stateStart ? classes.infoOverlayOpacity : classes.infoOverlay}> 
                                <p className={classes.info}>Сегодня очень жарко, но ты, как всегда вовремя. Вместе мы справимся быстрее.</p>
                            </div>
